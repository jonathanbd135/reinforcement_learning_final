...
if __name__ == '__main__':
    ...
    #
    # ddqn_1 = Agent(model_type='ddqn', betches_size=100, sync_models=50, per=True, env_number=2, is_stochastic=False)
    # ddqn_1.set_loger('huber_log_ddqn_2.csv')
    # ddqn_1.train_agent(episodes=1, epsilon=0.6, discount_factor=0.9)
    # while (np.average(ddqn_1.steps_taken[-5:]) < 50 and len(ddqn_1.steps_taken) < episodes_to_learn):
    #     ddqn_1.train_agent(episodes=5, epsilon=ddqn_1.epsilon, discount_factor=ddqn_1.discount_factor)
    # print(f'Total episodes: {len(ddqn_1.steps_taken)}')
    # loss_ddqn_1 = np.flip(pd.read_csv('huber_log_ddqn_2.csv', delimiter=';').loss.to_numpy())
    # quantile_95 = np.quantile(loss_ddqn_1, 0.95)
    # loss_ddqn_1 = np.arange(len(loss_ddqn_1[np.where(loss_ddqn_1 < quantile_95)])), loss_ddqn_1[
    #     np.where(loss_ddqn_1 < quantile_95)]
    # np.savetxt("loss_ddqn_2.csv", loss_ddqn_1, delimiter=",")
    # ddqn_1_actions_taken = np.array(ddqn_1.steps_taken)
    # np.savetxt("ddqn_2_actions_taken.csv", ddqn_1_actions_taken, delimiter=",")
    # ddqn_1_reward_eval = np.array(ddqn_1.reward_eval)
    # np.savetxt("ddqn_2_reward_eval.csv", ddqn_1_reward_eval, delimiter=",")
    #
    # dqn_1 = Agent(model_type='dqn', betches_size=100, sync_models=50, per=True, env_number=2, is_stochastic=False)
    # dqn_1.set_loger('huber_log_dqn_2.csv')
    # dqn_1.train_agent(episodes=1, epsilon=0.6, discount_factor=0.9)
    # while (np.average(dqn_1.steps_taken[-5:]) < 50 and len(dqn_1.steps_taken) < episodes_to_learn):
    #     dqn_1.train_agent(episodes=5, epsilon=dqn_1.epsilon, discount_factor=dqn_1.discount_factor)
    # print(f'Total episodes: {len(dqn_1.steps_taken)}')
    # loss_dqn_1 = np.flip(pd.read_csv('huber_log_dqn_2.csv', delimiter=';').loss.to_numpy())
    # quantile_95 = np.quantile(loss_dqn_1, 0.95)
    # loss_dqn_1 = np.arange(len(loss_dqn_1[np.where(loss_dqn_1 < quantile_95)])), loss_dqn_1[
    #     np.where(loss_dqn_1 < quantile_95)]
    # np.savetxt("loss_dqn_2.csv", loss_dqn_1, delimiter=",")
    # dqn_1_actions_taken = np.array(dqn_1.steps_taken)
    # np.savetxt("dqn_2_actions_taken.csv", dqn_1_actions_taken, delimiter=",")
    # dqn_1_reward_eval = np.array(dqn_1.reward_eval)
    # np.savetxt("dqn_2_reward_eval.csv", dqn_1_reward_eval, delimiter=",")
    #
    # ddqn_1 = Agent(model_type='ddqn', betches_size=100, sync_models=50, per=False, env_number=2, is_stochastic=False)
    # ddqn_1.set_loger('huber_log_ddqn_2_no_per.csv')
    # ddqn_1.train_agent(episodes=1, epsilon=0.6, discount_factor=0.9)
    # while (np.average(ddqn_1.steps_taken[-5:]) < 50 and len(ddqn_1.steps_taken) < episodes_to_learn):
    #     ddqn_1.train_agent(episodes=5, epsilon=ddqn_1.epsilon, discount_factor=ddqn_1.discount_factor)
    # print(f'Total episodes: {len(ddqn_1.steps_taken)}')
    # loss_ddqn_1 = np.flip(pd.read_csv('huber_log_ddqn_2_no_per.csv', delimiter=';').loss.to_numpy())
    # quantile_95 = np.quantile(loss_ddqn_1, 0.95)
    # loss_ddqn_1 = np.arange(len(loss_ddqn_1[np.where(loss_ddqn_1 < quantile_95)])), loss_ddqn_1[
    #     np.where(loss_ddqn_1 < quantile_95)]
    # np.savetxt("loss_ddqn_2_no_per.csv", loss_ddqn_1, delimiter=",")
    # ddqn_1_actions_taken = np.array(ddqn_1.steps_taken)
    # np.savetxt("ddqn_2_actions_taken_no_per.csv", ddqn_1_actions_taken, delimiter=",")
    # ddqn_1_reward_eval = np.array(ddqn_1.reward_eval)
    # np.savetxt("ddqn_2_reward_eval_no_per.csv", ddqn_1_reward_eval, delimiter=",")
    #
    # dqn_1 = Agent(model_type='dqn', betches_size=100, sync_models=50, per=False, env_number=2, is_stochastic=False)
    # dqn_1.set_loger('huber_log_dqn_2_no_per.csv')
    # dqn_1.train_agent(episodes=1, epsilon=0.6, discount_factor=0.9)
    # while (np.average(dqn_1.steps_taken[-5:]) < 50 and len(dqn_1.steps_taken) < episodes_to_learn):
    #     dqn_1.train_agent(episodes=5, epsilon=dqn_1.epsilon, discount_factor=dqn_1.discount_factor)
    # print(f'Total episodes: {len(dqn_1.steps_taken)}')
    # loss_dqn_1 = np.flip(pd.read_csv('huber_log_dqn_2_no_per.csv', delimiter=';').loss.to_numpy())
    # quantile_95 = np.quantile(loss_dqn_1, 0.95)
    # loss_dqn_1 = np.arange(len(loss_dqn_1[np.where(loss_dqn_1 < quantile_95)])), loss_dqn_1[
    #     np.where(loss_dqn_1 < quantile_95)]
    # np.savetxt("loss_dqn_2_no_per.csv", loss_dqn_1, delimiter=",")
    # dqn_1_actions_taken = np.array(dqn_1.steps_taken)
    # np.savetxt("dqn_2_actions_taken_no_per.csv", dqn_1_actions_taken, delimiter=",")
    # dqn_1_reward_eval = np.array(dqn_1.reward_eval)
    # np.savetxt("dqn_2_reward_eval_no_per.csv", dqn_1_reward_eval, delimiter=",")
    #
