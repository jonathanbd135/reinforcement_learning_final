...
if __name__ == '__main__':
    ...
    multi_env_agent_1.set_loger('multi_env_agent_log_1.csv')
    multi_env_agent_1.train_agent(episodes=1, epsilon=0.6, discount_factor=0.9)
    multi_env_agent_1.q_model.save(r'C:\Users\HP\Desktop\Finale\reinforcement_learning_final\weights\ex3_w\model_1')
    ...
    dqn_1_reward_eval = np.array(multi_env_agent_1.reward_eval)
    ...
    highway_env_agent.q_model.save(r'C:\Users\HP\Desktop\Finale\reinforcement_learning_final\weights\ex3_w\highway_model')
    merge_env_agent.q_model.save(r'C:\Users\HP\Desktop\Finale\reinforcement_learning_final\weights\ex3_w\merge_model')
    roundabout_env_agent.q_model.save(r'C:\Users\HP\Desktop\Finale\reinforcement_learning_final\weights\ex3_w\roundabout_model')
    multi_env_agent_2.q_model.save(r'C:\Users\HP\Desktop\Finale\reinforcement_learning_final\weights\ex3_w\model_2')
